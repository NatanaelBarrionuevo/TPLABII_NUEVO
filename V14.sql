CREATE DATABASE TIENDA_MUSICA_V14
GO
...
CONSTRAINT PK_LUTHIER PRIMARY KEY (ID_LUTHIER)
);
...
CONSTRAINT PK_TIPO_SERVICIO PRIMARY KEY (ID_T_SERV)
);
...
CONSTRAINT FK_DETALLE_SERVICIO_LUTHIERS FOREIGN KEY (ID_LUTHIER)
REFERENCES LUTHIERS (ID_LUTHIER),

CONSTRAINT FK_DETALLE_SERVICIO_TIPO_SERVICIO FOREIGN KEY (ID_T_SERV)
REFERENCES TIPO_SERVICIO (ID_T_SERV)
);
